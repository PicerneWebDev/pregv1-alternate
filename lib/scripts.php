...
//We remove this in favor of WP Jquery Plus to stay up to date with the latest bundled version
 ...
 *
 *  Please note that the Kit ID will change per installation
 *  i.e  src="//use.typekit.net/KITID.js" 
 */
function adobe_typekit_output(){ ?>
  <!-- Adobe Typekit Embed Code -->
  <script type="text/javascript" src="//use.typekit.net/hhl7nqh.js"></script>
  <script type="text/javascript">try{Typekit.load();}catch(e){}</script>
<?php } 

//Hook the adobe typekit function to wp_head
add_action('wp_head', 'adobe_typekit_output');
